        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active myhide"><a href="/saveproducts">Live View</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="table-responsive">
                <table id="protable" class="table table-bordered table-striped">
                  ...
                  <tr id="<?php echo "s_".$sp['id']; ?>" >
                    <td><?php echo $i; ?></td>
                    <td><?php echo $sp['title']; ?>
                    <td><?php echo 123; ?>

                    </td>
                    <td><?php echo 'N/A'; ?></td>
                    <td><?php echo $sp['price_par_item']; ?>
...
<td>
                    ...
                    <td>
                    <a href="/editproductdata/<?php echo $sp['id'];  ?>"><button  class="btn btn-success btn-xs"><i class="fa fa-edit" ></i></button></a>
                    <button onclick="deletedata(<?php echo $sp['id']  ?>,'/deleteproduct')" class="btn btn-danger btn-xs"><i class="fa fa-trash" ></i></button>
                    <button id="viewsupplier" data-name="<?php echo getsupplierdata($sp['supplier_id'],'name','id','suppliers'); ?>" data-address="<?php echo getsupplierdata($sp['supplier_id'],'address','id','suppliers'); ?>" onclick="viewsuppliermodaldata('<?php echo getsupplierdata($sp['supplier_id'],'name','id','suppliers'); ?>','<?php echo getsupplierdata($sp['supplier_id'],'address','id','suppliers'); ?>')" class="btn btn-danger btn-xs"><i class="fa fa-user" ></i>Supplier</button>
                    </td>
                  </tr>
