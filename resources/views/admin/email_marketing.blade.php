      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Website Newslatter</h3>
          ...
          <!-- /.card-header -->
          <form method="post" action="{{ route('send-email-marketing') }}">
          @csrf
          <div class="card-body">
          ...
          @foreach($data as $d)
         <div class="col-md-4">
         <input type="checkbox" name="emails[]" value="{{ $d->email }}" /><span>{{$d->name}}</span>
         </div>
          @endforeach
