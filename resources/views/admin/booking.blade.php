...
//print_r($data);
    ...
    <!-- Main content -->
              ...
              <div class="table-responsive">
                <table id="protable" class="table table-bordered table-striped">
                  ...
                  <tr id="<?php echo "s_".$sp->id; ?>" >
                    ...
                    <td><?php echo $sp->cnic; ?></td>
                    <td><?php echo $sp->phone; ?></td>
                    <td><?php echo $sp->hotel_name; ?></td>
                    <td><?php echo $sp->room_title; ?></td>
                    <td><?php echo $sp->from_date; ?></td>
                    <td><?php echo $sp->to_date; ?></td>
                    <td>
                    @if($sp->status==0)
      ...
      @endif
                    ...
                    <td>
                <a href="{{ route('delete-booking',$sp->id) }}" class="btn  btn-outline-danger"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
