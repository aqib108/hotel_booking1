<footer  class="page-footer bg-style">
            ...
            <div class="col-12 col-sm-6 col-lg-4 mt-5">
                ...
                <ul class="page-footer__address">
                    <li class="mb-2"><strong class="float-left mr-1">A:</strong>
                        Gulasht Road Near Chase-up Multan, Pakistan
                    </li>
                    <li class="mb-2"><strong class="float-left mr-1">P:</strong>
                        24/7 customer support:
                        <a href="tel:#">1-222-2222-22-22</a>
                    </li>
                    <li class="mb-2"><strong class="float-left mr-1">E:</strong>
                        <a href="mailto:#">paskistanibooking@gmail.com</a>
                    </li>
                </ul>
                <h4 class="h4 mb-2">Follow us:</h4>
                <ul class="footer-social d-flex flex-wrap">
                    <li class="mr-4"><a class="social-link" href="#" target="_blank"><i class="fab fa-facebook"></i></a></li>
                    <li class="mr-4"><a class="social-link" href="#" target="_blank"><i class="fab fa-twitter"></i></a></li>
                    <li class="mr-4"><a class="social-link" href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
                    <li class="mr-4"><a class="social-link" href="#" target="_blank"><i class="fab fa-youtube"></i></a></li>
                    <li class="mr-4"><a class="social-link" href="#" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
                </ul>
            </div>
            <div class="col-12 col-sm-6 col-lg-4 mt-5">
                ...
                <form class="subscribe-form" action="#" method="POST">
                    <div class="input-group input-group--lg flex-nowrap mb-4">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-btn btn-light btn--round" type="submit"><i class="fas fa-paper-plane"></i>
                            </button>
                        </div>
                    </div>
    ...
    <div class="page-footer__copyright text-center">
        <div class="container">
            <div class="hr"></div>YourTravelWorld ltd. All rights reserved.<br/><a class="text-light text-uppercase" href="#">Copyright by Pakistani Booking
