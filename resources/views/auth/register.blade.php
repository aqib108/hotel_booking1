    ...
    <div class="container">
        <div class="row justify-content-center mt-50" style="height: 100%;">
            ...
            <div class="col-12 text-center mt-50">
                <h3>Pakistani Booking Register Form </h3>
            </div>
            ...
            <div class="col-12 col-md-8 mt-30">
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('phone') is_invalid @enderror " data-inputmask="'mask': '0399-9999999'" name="phone" value="{{ old('phone') }}" placeholder="03XX-XXXXXXX" required=""  type = "number" maxlength = "12" required>
                    ...
                    <div class="form-group row">
                        <label for="" class="col-md-4 col-form-label text-md-right">Select User Type <span class="text-danger">*</span></label>
                        <div class="col-md-3">
                            <label class="custom-control custom-checkbox">
                                <input class="custom-control-input" name="user_type" value="hotel" id="" type="radio" required>
                                <span class="custom-control-label">Sign up as a Hotel</span>
                            </label>
                        ...
                        <div class="col-md-4">
                            <label class="custom-control custom-checkbox">
                                <input class="custom-control-input" id="" name="user_type" value="user" type="radio" required>
                                <span class="custom-control-label">Sign up as a User</span>
                            </label>
                            <div class="help-block"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="browseImageGroup">
                                {{--<label for="">Atached Resume</label>--}}
                                <div id="msg"></div>
                                <input type="file" name="file" id="img_file" class="file" accept="image/*" @if(isset($data['edit']) && !empty($data['edit'])) value="{{ $data['edit']['image'] }}" @else value="" @endif>
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-sm" disabled placeholder="Upload Image" id="file" @if(isset($data['edit']) && !empty($data['edit'])) value="{{ $data['edit']['image'] }}" @else value="" @endif required="required">
                                    <div class="input-group-append">
                                        <button type="button" class="browse btn btn-primary fileBorowseBtn">Browse Image</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="offset-md-4 col-md-6">
                            <div style="background-image: url({{ asset('images/avatar.png') }})"  id="preview" class="img-thumbnail previewImg"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="offset-md-2 col-md-8">
                            <label class="custom-control custom-checkbox">
                                <input class="custom-control-input" id="agreePolicy" name="terms_condition" type="checkbox" required>
                                <span class="custom-control-label">I have read and agree to the  <a href="#">Terms of Use</a> and the  <a href="#">Privacy Policy.</a></span>
                            </label>
                            <div class="help-block">Please accept our policy</div>
                        </div>
                    </div>
